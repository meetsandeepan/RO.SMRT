...
```json
{
  ...
  "id" : "ihe.ro.smrt",
  "url" : "https://profiles.ihe.net/RO/SMRT/ImplementationGuide/ihe.ro.smrt",
  "version" : "0.0.2-current",
  "name" : "IHE_RO_SMRT",
  "title" : "Shared Management of Radiation Treatments",
  "status" : "draft",
  "date" : "2026-06-18T23:58:34-04:00",
  ...
  "description" : "Defines the workflow and content necessary to connect any device-specific Treatment Management System (TMS) with a single departmental Radiation Oncology Information System (ROIS), enabling a holistic view of all ongoing treatments.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://profiles.ihe.net/RO/SMRT/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "CapabilityStatement/IHE.SMRT.rois"
      },
      "name" : "SMRT Radiation Oncology Information System (ROIS)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/IHE.SMRT.tms"
      },
      "name" : "SMRT Treatment Management System (TMS)",
    ...
    "page" : {
      ...
      "page" : [{
        ...
        "nameUrl" : "index.html",
        "title" : "1:X Shared Management of Radiation Therapy (SMRT) Home",
        "generation" : "markdown"
      },
      {
        "extension" : [{
        ...
        "title" : "1:X Shared Management of Radiation Therapy (SMRT) Volume 1",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "RO-SMRT-01.html"
        }],
        "nameUrl" : "RO-SMRT-01.html",
        "title" : "2:3.Y1 Sync Patient Photo [RO-SMRT-01]",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "RO-SMRT-02.html"
        }],
        "nameUrl" : "RO-SMRT-02.html",
        "title" : "2:3.Y2 Report Planning Artifacts [RO-SMRT-02]",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "RO-SMRT-03.html"
        }],
        "nameUrl" : "RO-SMRT-03.html",
        "title" : "2:3.Y3 Report Treatment Approval [RO-SMRT-03]",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "RO-SMRT-04.html"
        }],
        "nameUrl" : "RO-SMRT-04.html",
        "title" : "2:3.Y4 Report Treatment Artifacts [RO-SMRT-04]",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "RO-SMRT-05.html"
        }],
        "nameUrl" : "RO-SMRT-05.html",
        "title" : "2:3.Y5 Report Image Review Results [RO-SMRT-05]",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "domain-ZZ.html"
        }],
        "nameUrl" : "domain-ZZ.html",
        "title" : "3:Z.ZZ SMRT Content Modules",
        "generation" : "markdown"
      },
      {
        "extension" : [{
