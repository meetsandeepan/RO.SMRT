# 1:X Shared Management of Radiation Therapy (SMRT) Volume 1 - Shared Management of Radiation Treatments v0.0.2-current

* [**Table of Contents**](toc.md)
* **1:X Shared Management of Radiation Therapy (SMRT) Volume 1**
...
**Figure X.1-1: SMRT Actor Diagram**
...
**Table X.1-1: SMRT Profile - Actors and Transactions (defined by this profile)**
...
**Table X.1-2: SMRT Profile - Reused Transactions and Standards (via grouping)**
...
Requirements CapabilityStatement for [ROIS](CapabilityStatement-IHE.SMRT.rois.md).
...
Requirements CapabilityStatement for [TMS](CapabilityStatement-IHE.SMRT.tms.md).
...
**Table X.2-1: SMRT - Actors and Options**
...
**Table X.3-1: SMRT - Required Actor Groupings**
...
> **Editor's Note (provisional):** Required groupings are under review by the IHE-RO Technical Committee, including the precise PAM/scheduling groupings and the object store (OST) actor. See [Open Issues](issues.md).
...
**Figure X.4.2.1.2-1: Basic Process Flow in SMRT Profile**
...
This section will be expanded with the threat model, mitigations, and residual risks. See [Open Issues](issues.md).
